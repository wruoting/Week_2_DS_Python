...
def main():
    ...
    print('but it could provide a possible explanation for the increased frequency of 0. The distribution described by Benford\'s law does not seem to apply here. A possible explanation could also be that ')
    print('first orders of the day will generally round to 0. The least digit does not seem to be consistent throughout the years, but there is a frequency between 2, 7, and 8.')
